                        ...
                        <nav className="navbar navbar-expand-lg navbar-light">
                            <Link href="/">
                                <a onClick={toggleNavbar} className="navbar-brand">
                                    <img src="/images/logo.png" style={{height:80}} alt="logo" />
                                </a>
                            </Link>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="logo">
                                <Link href="/">
                                    <a className="d-inline-block">
                                        <img src="/images/logo.png" style={{height:80}} alt="image" />
                                    </a>
                                </Link>
                            </div>
                            ...
                            <ul className="social-list">
                                ...
                                <li><a href="#" target="_blank"><i className='bx bxl-twitch'></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
